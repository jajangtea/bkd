...
$this->breadcrumbs=array(
	'Perguruan Tinggi'=>array('index'),
	'Manage',
);

$this->menu=array(
	array('label'=>'<i class="icon icon-list"></i> Data Perguruan Tinggi', 'url'=>array('index')),
	array('label'=>'<i class="icon icon-adjust"></i> Tambah Perguruan Tinggi', 'url'=>array('create')),
);
